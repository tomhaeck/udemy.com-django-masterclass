...
urlpatterns = [
    ...
    path('password_change/', user_views.PasswordChange.as_view(template_name='users/password_change.html'), name='password_change'),
...
# https://docs.djangoproject.com/en/5.1/howto/static-files/#how-to-manage-static-files-e-g-images-javascript-css
